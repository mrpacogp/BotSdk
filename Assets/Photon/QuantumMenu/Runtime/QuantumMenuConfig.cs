namespace Quantum.Menu {
  ...
  /// <summary>
  /// Photon menu config file implements <see cref="IQuantumMenuConfig"/>.
  ...
  public class QuantumMenuConfig : QuantumScriptableObject, IQuantumMenuConfig {
    /// <summary>
    ...
    /// </summary>
    [InlineHelp, SerializeField] protected List<string> _availableAppVersions = new List<string> { "3.0" };
    /// <summary>
    /// Static list of regions available in the settings.
    /// An empty entry symbolizes best region option.
    /// An empty list will hide the related dropdown on the settings screen.
    /// </summary>
    [InlineHelp, SerializeField] protected List<string> _availableRegions = new List<string> { "eu", "us", "sa" };
    /// <summary>
