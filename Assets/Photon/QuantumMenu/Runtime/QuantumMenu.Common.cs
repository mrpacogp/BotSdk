...
namespace Quantum.Menu {
  ...
  /// <see cref="QuantumMenuConfig"/> can be derived or this interface implemented to change things.
  /// </summary>
  public interface IQuantumMenuConfig {
    /// <summary>
    ...
    /// </summary>
    QuantumMenuPartyCodeGenerator CodeGenerator { get; }
    /// <summary>
...
#region IQuantumMenuConnectArgs.cs
...
namespace Quantum.Menu {
  ...
  /// </summary>
  public interface IQuantumMenuConnectArgs {
    /// <summary>
    ...
    void SetDefaults(IQuantumMenuConfig config);
  }
}
...
#region IQuantumMenuConnection.cs
...
namespace Quantum.Menu {
  ...
  /// </summary>
  public interface IQuantumMenuConnection {
    /// <summary>
    ...
    Task<ConnectResult> ConnectAsync(IQuantumMenuConnectArgs connectArgs);
    /// <summary>
    /// Disconnect task.
    /// </summary>
    ...
    Task<List<QuantumMenuOnlineRegion>> RequestAvailableOnlineRegionsAsync(IQuantumMenuConnectArgs connectArgs);
  }
}
...
#region IQuantumMenuPopup.cs

namespace Quantum.Menu {
  using System.Threading.Tasks;

  /// <summary>
  /// Popup menu is implemented by <see cref="QuantumMenuUIPopup"/> screen.
  /// </summary>
  public interface IQuantumMenuPopup {
    /// <summary>
...
#region IQuantumMenuUIController.cs
...
namespace Quantum.Menu {
  ...
  /// </summary>
  public interface IQuantumMenuUIController {
    /// <summary>
    /// Show a screen by type.
    /// </summary>
    /// <typeparam name="S">Screentype</typeparam>
    void Show<S>() where S : QuantumMenuUIScreen;
    /// <summary>
    /// Start a popup.
    /// </summary>
    /// <param name="msg">Message</param>
    ...
    /// <typeparam name="S">Screentype</typeparam>
    /// <returns></returns>
    S Get<S>() where S : QuantumMenuUIScreen;
  }
}
...
namespace Quantum.Menu {
  ...
  /// </summary>
  public partial class QuantumMenuConnectArgs : IQuantumMenuConnectArgs {
    /// <summary>
    ...
    public virtual void SetDefaults(IQuantumMenuConfig config) {
      Session = null;
      Creating = false;
...
namespace Quantum.Menu {
  ...
  /// <summary>
  /// A wrapper for a <see cref="IQuantumMenuConnection"/> that is owned by a Unity game object and visible in the inspector this way.
  /// </summary>
  public abstract class QuantumMenuConnectionBehaviour : QuantumMonoBehaviour, IQuantumMenuConnection {
    /// <summary>
    /// The actual <see cref="IQuantumMenuConnection"/> object underneath. Is lazily created during either <see cref="ConnectAsync(IQuantumMenuConnectArgs)"/> or <see cref="RequestAvailableOnlineRegionsAsync"/>.
    /// </summary>
    public IQuantumMenuConnection Connection;
    /// <summary>
    ...
    /// </summary>
    public Action<IQuantumMenuConnectArgs> OnBeforeConnect;
    /// <summary>
    /// A shortcut to easily get notified about an impending disconnection.
    /// </summary>
    public Action<IQuantumMenuConnection, int> OnBeforeDisconnect;

    /// <summary>
    /// Factory method to be implemented in a derived class.
    /// </summary>
    /// <returns>Concrete <see cref="IQuantumMenuConnection"/> object.</returns>
    public abstract IQuantumMenuConnection Create();

    /// <summary>
    /// Connect using <see cref="IQuantumMenuConnectArgs"/>.
    /// </summary>
    /// <param name="connectionArgs">Connection arguments.</param>
    /// <returns>When the connection is established</returns>
    public virtual Task<ConnectResult> ConnectAsync(IQuantumMenuConnectArgs connectionArgs) {
      if (Connection == null) {
        Connection = Create();
      }
    ...
    public virtual Task<List<QuantumMenuOnlineRegion>> RequestAvailableOnlineRegionsAsync(IQuantumMenuConnectArgs connectionArgs) {
      if (Connection == null) {
        Connection = Create();
      }
...
#region QuantumMenuUIController.cs
...
namespace Quantum.Menu {
  ...
  public class QuantumMenuUIController<T> : QuantumMonoBehaviour, IQuantumMenuUIController where T : IQuantumMenuConnectArgs, new() {
    /// <summary>
    /// The menu config.
    /// </summary>
    ...
    /// </summary>
    [InlineHelp, SerializeField] protected QuantumMenuConnectionBehaviour _connection;
    /// <summary>
    ...
    /// <summary>
    /// The popup handler is automatically set if present based on the interface <see cref="IQuantumMenuPopup"/>.
    /// </summary>
    protected IQuantumMenuPopup _popupHandler;
    /// <summary>
    ...
    protected virtual void Awake() {
      ...
      foreach (var screen in _screens) {
        ...
        if (typeof(IQuantumMenuPopup).IsAssignableFrom(t)) {
          _popupHandler = (IQuantumMenuPopup)screen;
        }
      }
...
namespace Quantum.Menu {
  ...
  public abstract class QuantumMenuUIScreen : QuantumMonoBehaviour {
    ...
    /// <summary>
    /// The menu config, assigned by the <see cref="IQuantumMenuUIController"/>.
    /// </summary>
    public IQuantumMenuConfig Config { get; set; }
    /// <summary>
    /// The menu connection object, The menu config, assigned by the <see cref="IQuantumMenuUIController"/>.
    /// </summary>
    public IQuantumMenuConnection Connection { get; set; }
    /// <summary>
    /// The menu connection args.
    /// </summary>
    public IQuantumMenuConnectArgs ConnectionArgs { get; set; }
    /// <summary>
    /// The menu UI controller that owns this screen.
    /// </summary>
    public IQuantumMenuUIController Controller { get; set; }
    ...
    /// <summary>
    /// The screen init method is called during <see cref="QuantumMenuUIController{T}.Awake()"/> after all screen have been assigned and configured.
    /// </summary>
