...
namespace Quantum {
  ...
  public unsafe partial struct _globals_ {
    ...
    [FieldOffset(656)]
    public QBoolean AlreadyFilledRoom;
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + AlreadyFilledRoom.GetHashCode();
        return hash;
      }
    }
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        ...
        QBoolean.Serialize(&p->AlreadyFilledRoom, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Castle : Quantum.IComponentSingleton {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Collector : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public EntityRef DesiredCollectible;
    [FieldOffset(0)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 967;
        hash = hash * 31 + DesiredCollectible.GetHashCode();
        hash = hash * 31 + HasCollectible.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Collector*)ptr;
        QBoolean.Serialize(&p->HasCollectible, serializer);
        EntityRef.Serialize(&p->DesiredCollectible, serializer);
        FP.Serialize(&p->Speed, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Fighter : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public FP Power;
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct SpeedModifier : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (SpeedModifier*)ptr;
        FP.Serialize(&p->Multiplier, serializer);
        FP.Serialize(&p->Time, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct SpeedSpell : Quantum.IComponent {
    public const Int32 SIZE = 32;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 4177;
        hash = hash * 31 + (Int32)SpellType;
        hash = hash * 31 + SpeedMultiplier.GetHashCode();
        hash = hash * 31 + MultiplierDuration.GetHashCode();
        hash = hash * 31 + TTL.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (SpeedSpell*)ptr;
        serializer.Stream.Serialize((Int32*)&p->SpellType);
        FP.Serialize(&p->MultiplierDuration, serializer);
  ...
  public unsafe partial struct Spell : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 17291;
        hash = hash * 31 + (Int32)SpellType;
        hash = hash * 31 + ApplyToTarget.GetHashCode();
        hash = hash * 31 + ApplyToOthers.GetHashCode();
        hash = hash * 31 + Radius.GetHashCode();
        hash = hash * 31 + Speed.GetHashCode();
        hash = hash * 31 + TargetEntity.GetHashCode();
        hash = hash * 31 + SpellSequence.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Spell*)ptr;
        serializer.Stream.Serialize((Int32*)&p->SpellType);
        AssetRef.Serialize(&p->SpellSequence, serializer);
        EntityRef.Serialize(&p->TargetEntity, serializer);
        FP.Serialize(&p->ApplyToOthers, serializer);
        FP.Serialize(&p->ApplyToTarget, serializer);
        FP.Serialize(&p->Radius, serializer);
        FP.Serialize(&p->Speed, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Spellcaster : Quantum.IComponentSingleton {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [HideInInspector()]
    public QDictionaryPtr<ESpell, FP> SpellsCooldown;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 2053;
        hash = hash * 31 + SpellsCooldown.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      SpellsCooldown = default;
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.Spellcaster*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Spellcaster*)ptr;
        QDictionary.Serialize(&p->SpellsCooldown, serializer, Statics.SerializeESpell, Statics.SerializeFP);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Summoner : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public FP Interval;
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + ToSummon.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Summoner*)ptr;
        AssetRef.Serialize(&p->ToSummon, serializer);
        FP.Serialize(&p->Interval, serializer);
        FP.Serialize(&p->Timer, serializer);
    }
  }
  public unsafe partial interface ISignalOnSpellUsed : ISignal {
    void OnSpellUsed(Frame f, EntityRef casterEntity, ESpell spellType);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalOnSpellUsed[] _ISignalOnSpellUsedSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnSpellUsedSystems = BuildSignalsArray<ISignalOnSpellUsed>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Castle>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Castle>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Collector>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Collector>();
      BuildSignalsArrayOnComponentAdded<Quantum.Fighter>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Fighter>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.SpeedModifier>();
      BuildSignalsArrayOnComponentRemoved<Quantum.SpeedModifier>();
      BuildSignalsArrayOnComponentAdded<Quantum.SpeedSpell>();
      BuildSignalsArrayOnComponentRemoved<Quantum.SpeedSpell>();
      BuildSignalsArrayOnComponentAdded<Quantum.Spell>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Spell>();
      BuildSignalsArrayOnComponentAdded<Quantum.Spellcaster>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Spellcaster>();
      BuildSignalsArrayOnComponentAdded<Quantum.Summoner>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Summoner>();
    ...
    public unsafe partial struct FrameSignals {
      public void OnSpellUsed(EntityRef casterEntity, ESpell spellType) {
        var array = _f._ISignalOnSpellUsedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnSpellUsed(_f, casterEntity, spellType);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    public static FrameSerializer.Delegate SerializeESpell;
    public static FrameSerializer.Delegate SerializeFP;
    public static FrameSerializer.Delegate SerializeInput;
    static partial void InitStaticDelegatesGen() {
      SerializeESpell = (v, s) => {{ s.Stream.Serialize((Int32*)v); }};
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.Castle), Quantum.Castle.SIZE);
      typeRegistry.Register(typeof(CharacterController2D), CharacterController2D.SIZE);
      typeRegistry.Register(typeof(CharacterController3D), CharacterController3D.SIZE);
      typeRegistry.Register(typeof(Quantum.Collectible), Quantum.Collectible.SIZE);
      typeRegistry.Register(typeof(Quantum.Collector), Quantum.Collector.SIZE);
      typeRegistry.Register(typeof(ColorRGBA), ColorRGBA.SIZE);
      typeRegistry.Register(typeof(ComponentPrototypeRef), ComponentPrototypeRef.SIZE);
      typeRegistry.Register(typeof(ComponentTypeRef), ComponentTypeRef.SIZE);
      typeRegistry.Register(typeof(DistanceJoint), DistanceJoint.SIZE);
      typeRegistry.Register(typeof(DistanceJoint3D), DistanceJoint3D.SIZE);
      typeRegistry.Register(typeof(Quantum.ESpell), 4);
      ...
      typeRegistry.Register(typeof(Quantum.Fighter), Quantum.Fighter.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.SpeedModifier), Quantum.SpeedModifier.SIZE);
      typeRegistry.Register(typeof(Quantum.SpeedSpell), Quantum.SpeedSpell.SIZE);
      typeRegistry.Register(typeof(Quantum.Spell), Quantum.Spell.SIZE);
      typeRegistry.Register(typeof(Quantum.Spellcaster), Quantum.Spellcaster.SIZE);
      typeRegistry.Register(typeof(SpringJoint), SpringJoint.SIZE);
      typeRegistry.Register(typeof(SpringJoint3D), SpringJoint3D.SIZE);
      typeRegistry.Register(typeof(Quantum.Summoner), Quantum.Summoner.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 18)
        ...
        .Add<Quantum.Castle>(Quantum.Castle.Serialize, null, null, ComponentFlags.Singleton)
        .Add<Quantum.Collectible>(Quantum.Collectible.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.Collector>(Quantum.Collector.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.Fighter>(Quantum.Fighter.Serialize, null, null, ComponentFlags.None)
        ...
        .Add<Quantum.SpeedModifier>(Quantum.SpeedModifier.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.SpeedSpell>(Quantum.SpeedSpell.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.Spell>(Quantum.Spell.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.Spellcaster>(Quantum.Spellcaster.Serialize, null, Quantum.Spellcaster.OnRemoved, ComponentFlags.Singleton)
        .Add<Quantum.Summoner>(Quantum.Summoner.Serialize, null, null, ComponentFlags.None)
    ...
    public static void EnsureNotStrippedGen() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.ESpell>();
